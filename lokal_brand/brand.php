...
<html lang="en">
  ...
  <body>
    ...
    <thead>
    <a href="tambahbrand.php"><button type="button" class="btn btn-primary">Tambah Data</button></a>
    <br><br>
    <?php
  include 'koneksi.php';
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="editbrand.php?nama_brand=<?php echo $row['nama_brand'] ?>"><button type="button" class="btn btn-primary">Edit</button></a>
                            ||  <a href="deletebrand.php?nama_brand=<?php echo $row['nama_brand'] ?>"><button type="button" class="btn btn-primary">Delete</button></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
